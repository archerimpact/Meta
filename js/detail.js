...
function loadHeader(project) {
  template = [
		"<div class='row'>",
			...
			"<div class='col-md-2'>",
				"<br><br><br>",
				"<button type='' class='btn btn-primary float-right mb-2 command-buttons' data-toggle='tooltip' data-placement='right' title='Download as CSV' style='border-color: #0d77e2; background-color: #0d77e2; color=white' id='export{{projName}}'>",
					"<i class='material-icons'>file_download</i>",
				"</button>",
				'<br>',
				"<button type='' class='btn btn-danger float-right mb-2 command-buttons' data-toggle='tooltip' data-placement='right' title='Delete Project' style='border-color:#ff0099; background-color: #ff0099; color=white;' id='delete{{projName}}'>",
					"<i class='material-icons'>delete</i>",
				"</button>",
				"<br>",
				"<button type='' id='upload{{projName}}' class='btn btn-primary float-right mb-2 command-buttons' data-toggle='tooltip' data-placement='right' title='Add New Image' style='border-color: #0d77e2; background-color: #0d77e2; color: white'>",
